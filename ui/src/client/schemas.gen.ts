...
export const TranslatorSchema = {
    type: 'string',
    enum: ['youdao', 'google', 'deepl', 'llm', 'ammds'],
    title: 'Translator',
    showNames: ['有道', '谷歌', 'Deepl', 'LLM', 'AMMDS']
} as const;
...
export const WebsiteSchema = {
    type: 'string',
    enum: ['airav', 'airav_cc', 'avsex', 'avsox', 'cableav', 'cnmdb', 'dmm', 'faleno', 'fantastica', 'fc2', 'fc2club', 'fc2hub', 'fc2ppvdb', 'freejavbt', 'getchu', 'giga', 'hdouban', 'hscangku', 'iqqtv', 'jav321', 'javbus', 'javday', 'javdb', 'javlibrary', 'kin8', 'love6', 'lulubar', 'madouqu', 'mdtv', 'mgstage', '7mmtv', 'mywife', 'prestige', 'ammds', 'theporndb', 'xcity', 'dahlia', 'getchu_dmm', 'official'],
    title: 'Website',
    showNames: ['AIRAV', 'AIRAV_CC', 'AVSEX', 'AVSOX', 'CABLEAV', 'CNMDB', 'DMM', 'FALENO', 'FANTASTICA', 'FC2', 'FC2CLUB', 'FC2HUB', 'FC2PPVDB', 'FREEJAVBT', 'GETCHU', 'GIGA', 'HDOUBAN', 'HSCANGKU', 'IQQTV', 'JAV321', 'JAVBUS', 'JAVDAY', 'JAVDB', 'JAVLIBRARY', 'KIN8', 'LOVE6', 'LULUBAR', 'MADOUQU', 'MDTV', 'MGSTAGE', 'MMTV', 'MYWIFE', 'PRESTIGE', 'AMMDS', 'THEPORNDB', 'XCITY', 'DAHLIA', 'GETCHU_DMM', 'OFFICIAL']
} as const;